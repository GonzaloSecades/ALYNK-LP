...
<header class="text-gray-600 body-font shadow-xl ">
  ...
  <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
   ...
   <a href="/productos" class="text-alynkPrimary hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Productos</a>

   <a href="/contacto" class="text-alynkPrimary hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Contacto</a>
  </div>
 </nav>):null}
 </div>
 )
